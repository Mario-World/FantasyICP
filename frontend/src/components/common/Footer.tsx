      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">Fantasy Sports</h3>
            <p className="text-gray-300 mb-6 max-w-md">
              The ultimate fantasy sports platform where you can create teams, join contests, 
              and win real prizes. Experience the thrill of managing your dream team.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/tournaments" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Tournaments
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/how-to-play" className="text-gray-300 hover:text-blue-400 transition-colors">
                  How to Play
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/rewards" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Rewards
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Fantasy Sports. All rights reserved.
            </p>
